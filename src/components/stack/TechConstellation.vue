  ...
  <SectionWrapper id="stack" spacing="default">
    <div class="space-y-8">
      ...
      <div class="lg:hidden space-y-5 pt-2">
        <!-- Category Filter Pills (Generous Touch & Clean Glow) -->
        <div
          ...
          <button
            ...
            :class="
              activeMobileClusterIndex === idx
                ? 'bg-lime-400 text-black shadow-[0_0_18px_rgba(226,241,97,0.4)]'
                : 'bg-dark-900/90 text-slate-300 border border-lime-400/20 hover:text-white'
            "
            @click="selectCluster(idx)"
          >
            <span
              :class="activeMobileClusterIndex === idx ? 'text-black font-black' : 'text-lime-400'"
            >
        ...
        >
          <span class="text-[11px] font-mono text-lime-400 font-bold uppercase tracking-wider">
        ...
        <!-- Vertically Columned Skill Cards (Clean & Fast Scanning) -->
        <div class="space-y-3.5 pt-1">
          <SkillCard v-for="skill in activeMobileCluster.skills" :key="skill.name" :skill="skill" />
        </div>
      </div>
      ...
      <div class="hidden lg:block space-y-8">
        ...
        <div v-if="aiCluster" class="pt-4 space-y-4">
          ...
          >
            ...
            <span class="text-[10px] text-lime-400/80 font-mono">
